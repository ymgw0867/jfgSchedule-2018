...
namespace scheTask
{
    class clsXls
    {
        ...
        ///     前回更新日時</param>
        ///-----------------------------------------------------------------------
        public void xlsSelect(string sPath, DateTime sTime)
        {
            int sCnt = 0;

            // 指定フォルダのxlsxファイルを取得します
            xlsPath = sPath;
            foreach (string file in System.IO.Directory.GetFiles(xlsPath, "*.xlsx"))
            {
                // 前回の実行時間より更新日が新しいファイルを判定します
        ...
        private void entitySet(会員稼働予定 tbl, clsPersonalData cPData, int dDay)
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                if (i == 0) tbl.d1 = rng.Text.Trim();
                if (i == 1) tbl.d2 = rng.Text.Trim();
                if (i == 2) tbl.d3 = rng.Text.Trim();
                if (i == 3) tbl.d4 = rng.Text.Trim();
                if (i == 4) tbl.d5 = rng.Text.Trim();
                if (i == 5) tbl.d6 = rng.Text.Trim();
                if (i == 6) tbl.d7 = rng.Text.Trim();
                if (i == 7) tbl.d8 = rng.Text.Trim();
                if (i == 8) tbl.d9 = rng.Text.Trim();
                if (i == 9) tbl.d10 = rng.Text.Trim();
                if (i == 10) tbl.d11 = rng.Text.Trim();
                if (i == 11) tbl.d12 = rng.Text.Trim();
                if (i == 12) tbl.d13 = rng.Text.Trim();
                if (i == 13) tbl.d14 = rng.Text.Trim();
                if (i == 14) tbl.d15 = rng.Text.Trim();
                if (i == 15) tbl.d16 = rng.Text.Trim();
                if (i == 16) tbl.d17 = rng.Text.Trim();
                if (i == 17) tbl.d18 = rng.Text.Trim();
                if (i == 18) tbl.d19 = rng.Text.Trim();
                if (i == 19) tbl.d20 = rng.Text.Trim();
                if (i == 20) tbl.d21 = rng.Text.Trim();
                if (i == 21) tbl.d22 = rng.Text.Trim();
                if (i == 22) tbl.d23 = rng.Text.Trim();
                if (i == 23) tbl.d24 = rng.Text.Trim();
                if (i == 24) tbl.d25 = rng.Text.Trim();
                if (i == 25) tbl.d26 = rng.Text.Trim();
                if (i == 26) tbl.d27 = rng.Text.Trim();
                if (i == 27) tbl.d28 = rng.Text.Trim();
